...
const FULL_CONTROL_WARNING =
  ...
  + "the Admin-AI may use every right already granted to the ChimpMaera host "
  + "process, including shell, files, processes/services, packages, network, "
  + "modules, configuration and repair, without further ChimpMaera capability, "
  + "action or approval gates. ChimpMaera does not create OS rights: root needs "
  + "a separate visible owner elevation. With real root the Admin-AI can also "
  + "damage or remove ChimpMaera, its audit data and emergency controls; audit, "
