  ...
  while IFS= read -r account; do
    ...
    payload="$(
      jq -cn \
        ...
        --arg description "ChimpMaera synthetic demo fixture $fixture_id" \
  ...
  while IFS= read -r opportunity; do
    ...
    payload="$(
      jq -cn \
        ...
        --arg description "ChimpMaera synthetic $classification fixture $fixture_id" \
        ...
        provider_mutate dolibarr ThirdParty /thirdparties \
          ...
          jq -cn \
            ...
            '{name:$name,client:1,code_client:$code_client,email:$email,
              note_public:"ChimpMaera synthetic demo customer"}'
        )"
      )"
      customer_id="$(
        ...
        provider_mutate dolibarr Order /orders \
          ...
          jq -cn \
            ...
            '{socid:$socid,date:$date,ref_client:$ref_client,
              note_public:("ChimpMaera synthetic " + $classification
