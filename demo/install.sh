...
case "$profile" in
  SAFE_GUIDED) ;;
  RAMPAGE)
    printf >&2 '\nDANGER: RAMPAGE removes ChimpMaera approval gates inside this isolated demo only.\n'
