...
| ADD → REPLACE adaptability benchmark M0 | **Locally validated** | [Benchmark, method and measured record](../benchmarks/adaptability-m0/README.md), [M0 PDCA](../docs/development/adb-001-adaptability-benchmark-m0-pdca.md) | Two local in-process synthetic contracts reuse one unchanged Builder core and consumer; AI-blind input is prepared but not run. No live-provider, universal-adaptability, engineering-time or speed claim |
