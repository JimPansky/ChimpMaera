...
| Extension assurance profiles | **Locally validated** | [Assurance profile guide](EXTENSION-ASSURANCE-PROFILES.md), [ETL-01 local PDCA](../docs/development/etl-01-extension-assurance-profile-pdca.md) | Closed local-synthetic evidence assessment with eight hard-fail gates and private security routing; no scan, badge, acceptance, installation, activation, authority, certification or production claim |
