...
| Minimized agent-work event contract | **Locally validated** | [AWI-01 contract guide](AGENT-WORK-EVENT-CONTRACT.md), [local PDCA](../docs/development/awi-01-minimized-event-contract-pdca.md) | Pseudonymous, digest-bound synthetic contract with consent, finite retention and payload-free tombstones; no collection, telemetry, training, dashboard, ingestion or production claim |
