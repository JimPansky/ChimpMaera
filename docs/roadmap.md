...
maturity; regular [releases](https://github.com/JimPansky/ChimpMaera/releases/latest)
own shipped scope.
...
- A governed CRM/ERP business-intelligence demo:
  [issue #9](https://github.com/JimPansky/ChimpMaera/issues/9).
- A governed Power Apps-first integration:
  [issue #32](https://github.com/JimPansky/ChimpMaera/issues/32).
- One core with thin conformant harness adapters:
  [issue #36](https://github.com/JimPansky/ChimpMaera/issues/36).

These are selected orientation links, not a promise of order, date, funding,
compatibility, or delivery. Browse the
[full issue tracker](https://github.com/JimPansky/ChimpMaera/issues) for live
scope and status.
