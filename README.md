...
- `tools/video-production-reference/`: optional CPU-first video workflow,
  including replaceable reference voice and logo assets.
...
## Video Production Reference Docker
...
Citation metadata is provided in [CITATION.cff](CITATION.cff). Citation is
voluntary and does not replace license, notice, third-party, media or trademark
terms.
