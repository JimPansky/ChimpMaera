...
function mutate(fx, kind) {
  ...
  switch (kind) {
    ...
    case "MISSING_LATEST_RELEASE_FIELD":
      writeFileSync(
        join(fx.source, "README.md"),
        readFileSync(join(fx.source, "README.md"), "utf8").replace("https://github.com/JoFe2/PANSPHAIRA/releases/latest", "https://github.com/JoFe2/PANSPHAIRA/releases/missing"),
        "utf8",
      );
      break;
