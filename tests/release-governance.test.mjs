...
test("release governance negative probes fail closed", async (t) => {
  const probes = [
    ["README stale tag", "README_CURRENT_RELEASE_MISMATCH", (root) => replace(root, "README.md", "v0.2.0-poc.20260802.3", "v0.1.0")],
    ["README Daily identity", "README_ACTIVE_DAILY_IDENTITY_DENIED", (root) => replace(root, "README.md", "Governed Company Data Increment", "Today's Daily snapshot")],
