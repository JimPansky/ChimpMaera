...
test("release governance negative probes fail closed", async (t) => {
  const probes = [
    ...
    ["withdrawn video", "WITHDRAWN_ACTIVE_VIDEO_DENIED:8mB7O81Y2xA", (root) => replace(root, "README.md", "No video is release", "https://youtu.be/8mB7O81Y2xA\n\nNo video is release")],
    ...
    ["private path leak", "LEAK_PRIVATE_HOME_PATH:README.md", (root) => replace(root, "README.md", "No video is release", ["Current files: ", "home", "alice", "private", ""].join("/"))],
